...
export const trees = (
    ...
    treeThreeElement.style.top = '50px';

    treeFourElement.style.left = '350px';
    ...
    treeSevenElement.style.top = '150px';

    treeEightElement.style.left = '250px';
    treeEightElement.style.top = '150px';

    treeNineElement.style.left = '300px';
    treeNineElement.style.top = '150px';

    treeTenElement.style.left = '300px';
    treeTenElement.style.top = '200px';

    // treeElevenElement.style.left = '300px';
    // treeElevenElement.style.top = '250px';

    // treeTwelveElement.style.left = '300px';
    // treeTwelveElement.style.top = '300px';

    // treeThirteenElement.style.left = '150px';
    // treeThirteenElement.style.top = '250px';

    // treeFourteenElement.style.left = '150px';
    // treeFourteenElement.style.top = '300px';

    // treeFifteenElement.style.left = '150px';
    // treeFifteenElement.style.top = '350px';

    // treeSixteenElement.style.left = '150px';
    // treeSixteenElement.style.top = '400px';

    // treeSeventeenElement.style.left = '200px';
    // treeSeventeenElement.style.top = '400px';

    // treeEighteenElement.style.left = '250px';
    // treeEighteenElement.style.top = '400px';

    // treeNineteenElement.style.left = '0px';
    // treeNineteenElement.style.top = '450px';

    // treeTwentyElement.style.left = '450px';
    // treeTwentyElement.style.top = '450px';
